...
2. **New or existing match** — is she a new girl he's just started talking to, or someone he's already been in conversation with? If she's an existing match, check `~/.claude/dating-log.md` using the Read tool for any history with her and carry forward what's worked so far. If she's new, treat it as a fresh read with no prior context.
